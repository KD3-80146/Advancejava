...
<body>
	...
	<form:form method="post" modelAttribute="employee">
		<table style="background-color: lightgrey; margin: auto">
			<caption>Add Employee Form</caption>
			...
			<tr>
				...
				<td><form:radiobutton path="empType" value="FULL_TIME" />Full Time Role</td>
				<td><form:radiobutton path="empType" value="PART_TIME" />Part Time Role</td>
				<td><form:radiobutton path="empType" value="CONTRACT" />Contract Role</td>
			</tr>
			<tr>
